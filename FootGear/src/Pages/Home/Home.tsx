            ...
            <section>
                <div className="body-content">
                    <div className="body-cards-content">
                        <div className="b-titl">
                            <motion.h1 className="body-title" initial="hidden" whileInView="visible" custom={1} variants={textAnimation} viewport={{ once: true }}>Most popular</motion.h1>
